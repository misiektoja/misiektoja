...
| Project | Description |
| :--- | :--- |
| **[mac_software_updater](https://github.com/pr-fuzzylogic/mac_software_updater)** | Automated software updates for macOS |
| **[kill-process-mcp](https://github.com/misiektoja/kill-process-mcp)** | MCP server to list and kill OS processes |
| **[popclip_extensions](https://github.com/misiektoja/popclip_extensions)** | Collection of custom PopClip (macOS) extensions |
